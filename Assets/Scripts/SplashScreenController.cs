...
public sealed class SplashScreenController : MonoBehaviour
{
    ...
    void Update()
    {
        ...
        bool skipPressed = keyboard != null && keyboard.anyKey.wasPressedThisFrame;
    ...
    void OnGUI()
    {
        ...
        GUI.Label(
            ...
            isLoading ? "ENTERING THE KASAL..." : "PRESS ANY KEY",
            promptStyle);
    ...
    void EnsureStyles()
    {
        ...
        titleStyle = CreateStyle(FontStyle.Bold, new Color(0.9f, 0.76f, 0.48f));
        subtitleStyle = CreateStyle(FontStyle.Bold, new Color(0.82f, 0.76f, 0.66f));
        loreStyle = CreateStyle(FontStyle.Normal, new Color(0.93f, 0.9f, 0.84f));
        loreStyle.alignment = TextAnchor.UpperLeft;
        loreStyle.wordWrap = true;
        promptStyle = CreateStyle(FontStyle.Bold, new Color(0.78f, 0.58f, 0.24f));
    }
