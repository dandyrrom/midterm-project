...
public class CandleHUD : MonoBehaviour
{
    public CandleInventory inventory;
    public Image icon;
    ...
    {
        if (inventory == null)
            inventory = FindFirstObjectByType<CandleInventory>();
    ...
    {
        int max = inventory != null ? inventory.maxCount : 1;
